...
import { TreePine, Droplet, Zap, Calculator, Megaphone, Sparkles } from "lucide-react";
  ...
  return (
    <header className="sticky top-0 z-30 w-full glass-nav px-3 sm:px-6 py-2.5 sm:py-3 flex items-center justify-between gap-2 border-b border-surface-border">
      ...
      <div className="flex items-center gap-2.5">
        <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-robles-500 to-cyan-500 text-slate-950 flex items-center justify-center shadow-emerald-glow shrink-0">
        ...
        <div>
          <h1 className="text-sm sm:text-base font-bold text-white flex items-center gap-1.5 leading-tight">
            Los Robles
            <span className="text-[10px] px-1.5 py-0.2 rounded font-medium bg-robles-500/15 text-robles-400 border border-robles-500/30">
              Araure
            </span>
          </h1>
